...
export default function AdminStudentPage() {
  ...
  const fetchStudents = async () => {
    try {
      ...
      // Backend Data ကို Frontend UI Format သို့ ပြောင်းခြင်း
      const formatted = data.map((item: any, index: number) => ({
        ...
        phone: item.phone,
        dob: item.age.toString(), // Age ကို dob နေရာတွင် အစားထိုးပြပါမည်
        town: item.township,
        city: item.region,
    ...
    <div className={styles.container}>
      ...
      <header className={styles.navbar}>
        ...
        <div className={styles.navRight}>
          <img src="https://i.pravatar.cc/150?img=47" alt="Profile" className={styles.profileImg} />
          <span
                  ...
                  {paginatedStudents.length > 0 ? (
                    paginatedStudents.map((student, index) => (
                      ...
                      >
                        ...
                        <td>
                          <img src={student.image} alt="Student" className={styles.tableAvatar} />
                        </td>
                        <td>
          ...
          <div className={styles.formModalContent} onClick={(e) => e.stopPropagation()}>
            ...
            <form onSubmit={handleSubmit} className={styles.formBody}>
              ...
              <div className={styles.profileImgContainer}>
                <img src={formData.image || "https://i.pravatar.cc/150?img=1"} alt="Profile" className={styles.formProfileImg} />
              </div>
